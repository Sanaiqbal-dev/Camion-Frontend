  ...
  return (
    <Container fluid className="vh-100">
      ...
      <Row className="h-100">
        ...
        <Col xs={12} md={6} className="pt-3 py-3">
          <div className="auth-form-container">
            <Image className="col-lg-7" src={CamionLogo} />

            <div className="mt-4">
              <h1 className="h2 mb-3 font-weight-bolder">{t('registerNewAccount')}</h1>
              <p className="sub_heading mb-4">{t('registerNewAccountDescription')}</p>
            </div>
            <div className="form-container">
              <div>
                <div className="my-3 d-flex justify-content-start">
                  <div className="btn-container">
                    <div className={isCarrier ? 'customShipperButton' : 'customShipperButtonEnabled'} id="shipper-btn" onClick={() => setIsCarrier(false)}>
                      <svg width="40" height="41" viewBox="0 0 40 41" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path
                          ...
                          fill="#4F4F4F"
                        />
                        <path d="M32.7333 32.5981H27.9385V33.5321H32.7333V32.5981Z" fill="#4F4F4F" />
                        <path
                  ...
                  <div className="btn-container mx-4">
                    <div className={isCarrier ? 'customCarrierButtonEnabled' : 'customCarrierButton'} id="carrier-btn" onClick={() => setIsCarrier(true)}>
                ...
                <div>
                  <Row className="form-group mb-4">
                    <Form.Group as={Col} md="6">
                      <Form.Label className="customLabel">{t('firstName')}</Form.Label>
                      <Form.Control type="text" className="form-control customInput" {...register('firstName')} isInvalid={!!errors.firstName} placeholder={t('enterFirstName')} />
                      <Form.Control.Feedback type="invalid">{errors.firstName?.message}</Form.Control.Feedback>
                    </Form.Group>
                    <Form.Group as={Col} md="6">
                      <Form.Label className="customLabel">{t('lastName')}</Form.Label>
                      <Form.Control type="text" className="form-control customInput" {...register('lastName')} isInvalid={!!errors.lastName} placeholder={t('enterLastName')} />
                  ...
                  <Row className="form-group mb-4">
                    <Form.Group as={Col} md="6">
                      ...
                      <Form.Control type="email" className="form-control customInput" {...register('email')} isInvalid={!!errors.email} placeholder={t('enterEmail')} />
                      <Form.Control.Feedback type="invalid">{errors.email?.message}</Form.Control.Feedback>
                    </Form.Group>
                    <Form.Group as={Col} md="6" controlId="validationCustom04">
                      <Form.Label className="customLabel">{t('contactNumber')}</Form.Label>
                      <Form.Control
                        type="text"
                  ...
                  <Row className="form-group">
                    <Form.Group as={Col} md="6" controlId="validationCustom05">
                      ...
                      <Form.Control type="password" className="form-control customInput" placeholder={t('enterPassword')} {...register('password')} isInvalid={!!errors.password} />
    ...
    //                         <Form.Control type="text" className="form-control customInput" {...register('lastName')} isInvalid={!!errors.lastName} placeholder="Enter last name" />
    //                         <Form.Control.Feedback type="invalid">{errors.lastName?.message}</Form.Control.Feedback>
    //                       </Form.Group>
    //                     </Row>
    //                     <Row className="form-group mb-4">
    ...
    //                       </Form.Group>
    //                       <Form.Group as={Col} md="6" controlId="validationCustom04">
    //                         <Form.Label className="customLabel">Contact Number</Form.Label>
    //                         <Form.Control
    //                           type="text"
    //                           className="form-control customInput"
    //                           defaultValue="+966"
