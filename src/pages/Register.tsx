      ...
      <Row className="h-100">
        ...
        <Col xs={12} md={6} className="pt-3 py-3">
          <div className="auth-form-container">
            <div>
              <Image className="col-lg-7" src={CamionLogo} style={{ height: '30px', marginLeft: '-80px' }} />
            </div>

            <div className="mt-1">
              <h1 className="h4 mb-1 font-weight-bolder">{t('registerNewAccount')}</h1>
              <p className="sub_heading mb-2">{t('registerNewAccountDescription')}</p>
            </div>
                ...
                <div>
                  <Row className="form-group mb-2">
                    <Form.Group as={Col} md="6">
                      ...
                      <Form.Control type="text" className="form-control" {...register('firstName')} isInvalid={!!errors.firstName} placeholder={t('enterFirstName')} />
                  ...
                  <Row className="form-group">
                    <Form.Group as={Col} md="6" controlId="validationCustom05">
                      ...
                      <Form.Control type="password" className="form-control  " placeholder={t('enterPassword')} {...register('password')} isInvalid={!!errors.password} />
