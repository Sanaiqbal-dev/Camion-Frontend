  ...
  return (
    <>
      ...
      <Modal show={modal.show} onHide={handleCloseModal} centered size={'lg'} backdrop="static" keyboard={false}>
        ...
        <Modal.Body>
          <Form onSubmit={handleSubmit(onSubmit)} className="tw-flex tw-flex-col tw-gap-3 tw-mb-10">
            <Form.Group className="mb-3" style={{ flex: 1, width: '80%' }}>
            ...
            <Form.Group className="mb-3" controlId="formBasicEmail" style={{ flex: 1, width: '80%' }}>
