...
const Dashboard = () => {
  return (
    <div className="tw-flex tw-flex-col tw-gap-5" style={{paddingTop:"15px", maxHeight:"calc(100vh - 60px)", overflowY:"scroll"}}>
      ...
      <div
        className="row additional-stats"
        style={{ backgroundColor: "#F3F3F3" }}
      >
        <div
          className="col additional-stats-item border-right"
          style={{ backgroundColor: "#FFC5C5" }}
        >
          <span style={{ alignSelf: "flex-start", fontSize: "14px" }}>
            Overspeed
          </span>
          <span
            style={{
          ...
          <span style={{ alignSelf: "flex-end", fontSize: "14px" }}>
            Alerts
          </span>
          <span
            style={{
