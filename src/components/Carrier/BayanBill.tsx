        ...
        <Row>
          <Col className="tw-flex tw-flex-col tw-gap-6">
            <Card className="bayan-bill-card">
              <h5 style={{ fontWeight: "700", color: "#0060B8" }}>
                Shipper Information
              </h5>
              <h6 style={{ fontWeight: "700", color: "#535353" }}>
                Origin Details
              </h6>
              ...
              <div className="bill-main-content">
                ...
                <div>
                  ...
                  <p style={{ color: "#333333", fontWeight: "500", flex:"2", lineHeight:"15px" }}>
                    Count on us for reliable and efficient shipping solutions,
                    locally and internationally. Our dedicated team ensures safe
                    and timely deliveries. Experience hassle-free shipping with
                    us
                  </p>
                </div>
              </div>
