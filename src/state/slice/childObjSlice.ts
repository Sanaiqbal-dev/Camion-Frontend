...
const childObjSlice = createSlice({
  ...
  initialState,
  reducers: {
		openChildDrawer(state:any, action: PayloadAction<{objKey:string, filterKeys:Record<string, any>, label: string, objName: string, type: RelationshipType, m2MSelectedValue?: CommonSelect }>) {   
